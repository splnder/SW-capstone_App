...
public class ReceiverListDelete extends Activity {
    Integer receiverID;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.receiver_delete_view);
    ...
    public void accept(View view) {
        ...
        try{
            ...
            String res = httpRequest.execute("deleteReceiver", String.valueOf(receiverID)).get();
            if(!res.isEmpty()){
